        ...
        <section class="signup_section">
          ...
          <div class="signup_form">
            <div class="section_title">
              <h2> Welcome to <span>iCard</span> </h2>
              <p>Type your E-mail and Password</p>
            </div>
            <form id="login">
            ...
            <div class="or_option">
              <p>Already have an account? <a href="sign-up.php">Sign Up here</a></p>
              <p>Forget <a href="forget-password.php">Password</a></p>
            </div>
          </div>
        </section>
      </div>
