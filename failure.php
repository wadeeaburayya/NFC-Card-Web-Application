...
<head>
    ...
    <!--<meta http-equiv="refresh" content="3;url=packages.php">-->
            ...
            <div class="container">
                <section class="signup_section">
                    ...
                    <div class="signup_form">
                        <div class="content">
                            <h1><i class="fas fa-times-circle text-danger"></i> Payment Not Successful!</h1>
                            <?php if (isset($result['ErrorMsg'])) : ?>
                                <p>Reason why it was unsuccessful: <?php echo $result['ErrorMsg']; ?></p>
                            <?php else : ?>
                                <p>Reason for failure not available.</p>
                            <?php endif; ?>
                            <p>To go back to Packages <a href="packages.php">click here</a>.</p>
                        </div>
                    </div>
                </section>
            </div>
