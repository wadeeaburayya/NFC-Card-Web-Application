<?php
$bmidBranding = $_SESSION['member_id'];
$queryBranding = "SELECT SUM(bblimit) as totalLimit FROM billing WHERE bmid = '$bmidBranding'";
$resultBranding = $conn->query($queryBranding);

if ($resultBranding && $resultBranding->num_rows > 0) {
    $billingDataBranding = $resultBranding->fetch_assoc();
    $bblimitBranding = $billingDataBranding['totalLimit'];

    // Check if bblimit is 0
    if ($bblimitBranding == 0) {
        $showBrandingButton = false;
    } else {
        $showBrandingButton = true;
    }
} else {
    // No billing data found, handle the case accordingly
    $showBrandingButton = true; // Show the button by default if no billing data is found
}
?>
    ...
    <div class="nav-content d-flex">
        ...
        <div class="user-container d-flex">
            <a href="#" class="d-flex user position-relative" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="profile" alt="profile" src="uploads/<?php echo $fullName['pp']; ?>" />
                <div class="name"><?php echo $fullName['namesurname']; ?></div>
            </a>
            ...
            <ul id="menu" class="menu">
                ...
                <li>
                    <a href="Customers.List.php">
                        ...
                        <span class="label">iCard</span>
                    </a>
                </li>
                <?php if ($showBrandingButton) : ?>
